                    ...
                    <li className="dropdown">
                      ...
                      <div className="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        <a href="mydash.html" className="dropdown-item">
                          <i className="dropdown-icon icon icon-user"></i> My
                          Profile
                        </a>
                        <a className="dropdown-item" href="ad-posts.html">
                          <i className="dropdown-icon icon icon-plus"></i> Add
                          Post
                        </a>
                        <a className="dropdown-item" href="my-jobs.html">
                          <i className="dropdown-icon icon icon-briefcase"></i>{" "}
                          My Jobs
                        </a>
                        <a href="mydash.html" className="dropdown-item">
                        ...
                        <a className="dropdown-item" href="login.html">
                          <i className="dropdown-icon icon icon-power"></i> Log
                          out
                        </a>
                      </div>
                    </li>
          ...
          <div className="horizontal-header clearfix ">
            <div className="container">
              ...
              <span className="smllogo">
                <img
                  src="/assets/images/brand/taxgatha.jpeg"
              ...
              <a href="/#" className="callusbtn">
                <i className="fa fa-bell text-body" aria-hidden="true"></i>
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="horizontal-main clearfix">
            <div className="horizontal-mainwrapper container clearfix">
              <a className="desktoplogo" href="/#">
                <img
                  src="/assets/images/brand/Logo_Leaves.png"
                  className="header-brand-img desktop-logo"
                  alt="logo"
                />
                <img
                  src="../assets/images/brand/white-logo.png"
                  className="header-brand-img dark-logo"
                  alt="Jobslist logo"
                />
              </a>
