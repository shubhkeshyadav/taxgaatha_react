...
function Contactus()
{
    return (
        <>
        <div className="bannerimg cover-image bg-background3" data-image-src="assets/images/banners/banner2.jpg" style={{backgroundImage: 'assets/images/banners/banner1.jpg', backgroundPosition: 'center center'}}>
        ...
        <div className="sptb bg-white">
            <div className="container">
            <div className="row">
                <h3 className="widget-title fs-16 mt-6">Support Number &amp; Email ID</h3>
                    ...
                    <div className="card-body">
                        ...
                        <div className="row text-white">
                            ...
                            <div className="support-service bg-dark br-2">
                                ...
                                <p>A-27A, Rama Park Uttam Nagar, New Delhi. India - 110059</p>
                            </div>
                            </div>
                            ...
                            <div className="support-service bg-dark br-2">
                                ...
                                <p><a href="https://www.google.com/maps/place/28%C2%B037'14.7%22N+77%C2%B002'12.2%22E/@28.6207456,77.0345443,17z/data=!4m5!3m4!1s0x0:0x78d09997088ddf54!8m2!3d28.6207456!4d77.036733?hl=en" target="_blank">Click to view direction</a></p>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <h3 className="widget-title fs-16 mt-6">We are here to help you, submit your query to us.</h3>
                <hr className="widget-hr" />
                <div className="col-md-5">
                <div className="single-page"><div className="col-lg-12 col-xl-12 col-md-12 d-block mx-auto">
                    <div className="wrapper wrapper2">
                        <form id="contactus_form" className="card-body" tabIndex={500}>
                        @csrf
                        ...
                        <div className="message mb-5">
                            <textarea id="message" className="form-control" name="message" rows={6} defaultValue={""} />
                            <label>Message</label>
                        </div>
                        <div className="submit mb-0 col-md-6 text-center d-block mx-auto">
                            <a className="btn btn-primary btn-block" href="{undefined}">Send Message</a>
                        </div>
                        </form>
                    </div>
                    </div>
